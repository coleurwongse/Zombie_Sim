...
The goal of civilizations is to have a way for the humans to mount an organized defense against the zombies, and to distinguish between nations (zombies aren't the only enemy). Currently, the civilizations are very basic, but I will try to implement behavior into them soon.
